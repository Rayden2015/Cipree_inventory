            ...
            <div class="card-header">
                ...
                <form action="{{ route('stores.supply_history_search_item') }}" method="GET">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Search Description or Part Number, Enduser or Stock Code" aria-describedby="basic-addon2" name="search" value="{{ request('search') }}">
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
