    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $pending_request_approvals }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #19AF9D;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $pending_po_approvals }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $pending_stock_approvals }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #19AF9D;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $approved_request }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $approved_pos }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #19AF9D;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $processed_pos }}</h4>
        ...
        <div class="col-lg-3 col-6">
            <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                <div class="inner">
                    <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $processed_request }}</h4>
