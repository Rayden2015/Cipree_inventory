            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #19AF9D;" class="small-box" id="rcorners1">
                        <div class="inner">
                            ...
                            <h4 style="color: white; font-family: 'Segoe UI Light';">{{ $total_no_of_parts }}</h4>
                        ...
                        <a href="{{ route('items_list_site') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                        <div class="inner">
                            ...
                            <h4 style="color: white; font-family: 'Segoe UI Light';">{{ '$ ' . $total_cost_of_parts }}</h4>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #19AF9D" class="small-box" id="rcorners1">
                        ...
                        <a href="{{ route('stores.supply_history') }}" class="small-box-footer">More info
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #0e6258;" class="small-box " id="rcorners1">
                        ...
                        <a href="{{ route('inventories.inventory_item_history') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                        <div class="inner">
                            ...
                            <h4 style="color: white; font-family: 'Segoe UI Light';">{{$sofficer_stock_request_pending}}
                            </h4>
                        ...
                        <a href="{{ route('dashboard.sofficer_stock_request_pending') }}" class="small-box-footer">More info
                            <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                        ...
                        <a href="{{ route('dashboard.reorder_level') }}" class="small-box-footer">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
...
<br> <br>
        ...
        <script>
            ...
            @if (!empty($stockDistribution))
                var ctx = document.getElementById('stockDistributionChart').getContext('2d');
                var stockDistributionData = @json($stockDistribution);
        ...
        <script>
            ...
            var stockValueByTypeData = @json($stockValueByType);
