...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-cogs"></i> Add Part</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus-circle mr-1"></i> Create New Part</h3>
                ...
                <form action="{{ route('parts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="livesearch form-control @error('supplier_id') is-invalid @enderror" 
                                        name="supplier_id" 
                                        id="supplier_id">
                                </select>
                                @error('supplier_id')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="livesearch2 form-control @error('site_id') is-invalid @enderror" 
                                        name="site_id" 
                                        id="site_id" 
                                        required>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="livesearch3 form-control @error('location_id') is-invalid @enderror" 
                                        name="location_id" 
                                        id="location_id">
                                </select>
                                @error('location_id')
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-1"></i> Save Part
                        </button>
