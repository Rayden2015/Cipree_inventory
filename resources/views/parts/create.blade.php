                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="livesearch form-control p-3" name="supplier_id" required></select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="livesearch2 form-control p-3" name="site_id" required></select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="livesearch3 form-control p-3" name="location_id" required></select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ old('quantity') }}" name="quantity" required
                                            class="form-control">
                                    </div>
                                </div>
