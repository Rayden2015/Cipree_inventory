...
@section('content')
    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="purchaseForm" action="{{ route('purchases.purchase_update', $purchase_order->id) }}"
                    ...
                    @hasanyrole('purchasing_officer|authoriser')
                        <div class="card-body" id="myDiv">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="aunit_price" class="form-control"
                                                    name="unit_price" placeholder="unit price"></td>
                                            ...
                                            <td><button type="submit" class="btn btn-primary"
                                                    onclick="saveNewRow()">Save</button></td>
                                        </tr>
                                ...
                                <div class="card-body" id="myDiv">
                                    <div class="table-responsive">
                                        <p style="margin-left: 800px;">Sub Total (Excluding Tax & Levies):
                                            {{ $grandtotal }}</p>
                                        <form action="{{ route('savelevytax_porder', $purchase_order->id) }}"
                                            method="post" enctype="multipart/form-data" id="taxlevyForm">
                                            @csrf
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="number" class="form-control new_results"
                                                                readonly name="value">
                                                        </td>
                                                        <td><button id="addRowBtn" class="btn btn-primary">Add
                                                                Tax</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="card-body" id="myDiv">
                                    <div class="table-responsive">
                                        {{-- <p style="margin-left: 800px">Sub Total (Inlc Levy):</p> --}}
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="number" class="form-control new_results2" readonly
                                                            name="values2">
                                                    </td>
                ...
                <div class="form-group">
                    ...
                    @if (Auth::user()->hasRole('purchasing_officer'))
                        <input type="text" name="created_by" style="width:40%"
                            value="{{ $purchase_order->created_by }}" class="form-control" readonly>
                    @else
                        <input type="text" name="created_by" style="width:40%"
                            value="{{ $purchase_order->created_by }}" class="form-control" readonly>
                    @endif
                ...
                <div class="form=group">
                    ...
                    <input type="text" name="notes" style="width:40%" value="{{ $purchase_order->notes }}"
                        class="form-control">
                </div>
            </div>
        </div>
        ...
        {{-- <script>
            ...
            function saveTaxLevyValues(formData) {
                fetch('{{ route('save.tax.levy.values') }}', {
                        method: 'POST',
                        body: formData
                    })
            ...
            // Event listener for changes in tax_id and tax_value
            document.querySelectorAll('select[name="tax_id"], input[name="tax_value[]"]').forEach(function(element) {
                element.addEventListener('change', function() {
                    const formData = new FormData(document.getElementById('taxlevyForm'));
                    saveTaxLevyValues(formData);
                });
            });

            // Event listener for changes in levy_id and levy_value
            document.querySelectorAll('select[name="levy_id"], input[name="levy_value[]"]').forEach(function(element) {
                element.addEventListener('change', function() {
                    const formData = new FormData(document.getElementById('taxlevyForm'));
                    saveTaxLevyValues(formData);
                });
        ...
        <script>
            function saveDraft() {
                ...
                document.getElementById("purchaseForm").action = "{{ route('save_draft', $purchase_order->id) }}";
            ...
            function submitForm() {
                ...
                document.getElementById("purchaseForm").action =
                    "{{ route('purchases.purchase_update', $purchase_order->id) }}";
            ...
            function saveNewRow() {
                // Set action for submitting
                document.getElementById("purchaseForm").action =
                    "{{ route('purchases.purchase_update_row', $purchase_order->id) }}";
    ...
    @endforeach
                        ...
                        <td> <input type="number" class="form-control new_results" readonly name="value"></td>
                        <td>
        ...
        <script>
            ...
            <tr>
                ...
                <td> <input type="number" class="form-control new_results2" readonly name="values2"></td>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#tax_id_table').on('change', 'select[name="tax_id"]', function() {
                    ...
                    $(this).closest('tr').find('.new_results').val(percentage.toFixed(2));
                ...
                function updateSum() {
                    ...
                    $('.new_results').each(function() {
                        ...
                        var value = parseFloat($(this).val()); // Get the value as float
                ...
                // Event listener for when the content of <input class="new_results"> changes
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#levy_id_table').on('change', 'select[name="levy_id"]', function() {
                    ...
                    // Update the content of the <input class="new_results2">
                    $(this).closest('tr').find('.new_results2').val(calculatedRate.toFixed(2));
                ...
                // Event listener for when the content of <input class="new_results2"> changes
