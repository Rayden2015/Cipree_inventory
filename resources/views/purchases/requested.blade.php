...
@section('content')
    ...
    <head>
        ...
        <title>Requested Purchases</title>
    ...
    <body>
        ...
        <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            @hasanyrole('Admin|purchasing_officer')
                                <th>Edit</th>
                            @endhasanyrole
                            <th>Delete</th>
            ...
            {{ $requested->links('pagination::bootstrap-4') }}
            <!-- /.card-body -->
        </div>
