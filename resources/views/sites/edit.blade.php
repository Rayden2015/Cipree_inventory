                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $site->name }}" required type="text" name="name"
                                            class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Site Code: <span class="text-danger"></span></label>
                                        <input value="{{ $site->site_code }}" required type="text" name="site_code"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
