...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-upload"></i> Bulk Import Endusers</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('endusers.index') }}">Endusers</a></li>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('endusers.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <ul>
                                    ...
                                    <li>Required columns: name_description, type, department_name, section_name</li>
                                    <li>Type must be one of: Equipment, Personnel, Organisation</li>
                                    <li>Department and Section names must match existing records in your system</li>
                                    <li>Optional columns: asset_staff_id, model, serial_number, manufacturer, designation, status, category_name</li>
                                </ul>
                            </div>
                            ...
                            <div class="form-group">
                                <a href="{{ route('endusers.import.template') }}" class="btn btn-info">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-upload mr-2"></i>Import Endusers
                            </button>
                            <a href="{{ route('endusers.index') }}" class="btn btn-secondary">
