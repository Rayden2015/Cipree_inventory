...
@section('content')
    ...
    <head>
        ...
        <title>PO Approved Direct Request</title>
        ...
        @endif
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @forelse ($po_approved_direct_requests as $in)
                        <tbody>
                            <tr>
                                <td>{{ $in->id }}</td>
            ...
            {{ $po_approved_direct_requests->links('pagination::bootstrap-4') }}
            <!-- /.card-body -->
        </div>
