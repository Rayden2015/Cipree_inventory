...
@section('content')
    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        @forelse ($pending_stock_approvals as $rq)
                            {{-- expr --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('sorders.authoriser_store_list_view_dash', $rq->id) }}" class="btn btn-secondary">View</a>
            ...
            {{ $pending_stock_approvals->links('pagination::bootstrap-4') }}
            <!-- /.card-body -->
        </div>
