...
@section('content')
    ...
    <body>
        ...
        @endif
            ...
            {{ $po_approved_pos->links('pagination::bootstrap-4') }}
            <!-- /.card-body -->
        </div>
