    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{ route('spr_lists') }}" class="btn btn-primary float-right">Back</a>
            </div>
            @if (session('success'))
        ...
        @endif
            <div class="card-body">
                ...
                <form action="{{ route('store_officer_spr_update', $sorder->id) }}" method="POST"
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($sorder_parts as $ph)
                            <tr>
                                ...
                                <form action="{{ route('so_spr_update', $ph->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                ...
                <div class="card-footer">
                    <form action="{{ route('authoriser_remarks_update',$sorder->id) }}" method="post">
                        ...
                        <input type="text" name="authoriser_remarks" id="authoriser_remarks"
                            class="form-control" style="width:30%" value="{{ $sorder->authoriser_remarks }}"> <br>
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </form>
                </div>
                @endif
