    ...
    <body>
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <a href="{{ route('auth_spr_lists') }}" class="btn btn-primary float-right">Back</a>
            </div>
                            ...
                            <div class="card-footer">
                                <form action="{{ route('authoriser_remarks_update', $sorder->id) }}" method="post">
                                    ...
                                    <input type="text" name="authoriser_remarks" id="authoriser_remarks"
                                        class="form-control" style="width:30%" value="{{ $sorder->authoriser_remarks }}">
                                    <br>
                                    <button type="submit" class="btn btn-primary">Submit</button>
                                </form>
                            </div>
