                    ...
                    <tbody>
                        ...
                        @foreach ($spr_lists as $order)
                            <tr>
                                ...
                                @if (
                                    (Auth::user()->hasRole('store_officer') && $order->approval_status == '') ||
                                        $order->approval_status == 'Denied')
                                    <td> <label for="">Not Approved</label></td>
                                @elseif(Auth::user()->hasRole('store_officer'))
                                    <td><a href="{{ route('store_officer_spr_edit', $order->id) }}"
