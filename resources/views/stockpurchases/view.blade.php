           ...
           <br>
            ...
            <div style="min-width: 600px">
                ...
                border-bottom: 1px solid #fff">
                    ...
                    @endif
                    {{-- @if (
                        (Auth::user()->role->name == 'store_officer' && $sorder->approval_status == 'Approved') ||
                            (Auth::user()->role->name == 'store_assistant' && $sorder->approval_status == 'Approved'))
            ...
            @if (
                ...
                <a href="{{ route('stores.store_officer_edit', $sorder->id) }}" class="float-right"
