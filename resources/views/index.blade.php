                ...
                <div class="col-lg-9 text-center">
                    ...
                    <form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up"
                        ...
                        <input type="text" class="form-control px-4"
                            placeholder="Your ZIP code or City. e.g. Lome" />
      ...
      <div class="container">
        <div class="row mb-5 align-items-center">
          ...
          <div class="col-lg-6 text-lg-end">
            <p>
              <a href="{{ route('pages.property') }}" target="_blank" class="btn btn-primary text-white py-3 px-4">View all properties</a>
            </p>
          </div>
        </div>
        <div class="row">
            ...
            <div class="property-slider-wrap">
              ...
              <div class="property-slider">
                ...
                <div class="property-item">
                  <a href="{{ route('property.show',$property->id) }}" class="img">
                    <img src="cover/{{ $property->cover }}" alt="Image" class="img-fluid" style="width:400px; height:400px;" />
                  </a>
  
                  <div class="property-content">
                    <div class="price mb-2"><span>${{ $property->price ?? '' }}</span></div>
                    <div>
                      <span style="font-size:14px; text-align:justify" class="d-block mb-2 text-black-50">{{ $property->location ?? '' }}</span>
                      <span class="city d-block mb-3">{{ $property->state->name ?? '' }}, {{ $property->country->name ?? '' }}</span>
                      ...
                      <a href="{{ route('property.show',$property->id) }}" class="btn btn-primary py-2 px-3">See details</a>
                    </div>
                  </div>
                </div>
                <!-- .item -->
