  ...
  margin-left:($spacer * .25) !important;
            ...
            <div class="content-page">
                ...
                @endif
                                    ...
                                    "{{route('category.update',$category->id)}}" @else() "{{route('orders.orderstore')}}" @endif method="post" >
                                    @if (isset($category))
                                        @method('PUT')
                                    @endif
                     ...
                     <!-- Form row -->
                                      ...
                                      <div class="card-box" style="box-shadow: 0 25px 35px 0 lightgrey">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-inline ml-5">
                                                ...
                                                <label for="inputCity" class="col-form-inline">Request Number</label>
                                                <input name="request_number" value="{{ $request_number }}" type="text" readonly class="form-control date-pick ml-3"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="inputCity" class="col-form-label">Requester </label>
                                                <select class="livesearch4 form-control p-3" name="user_id"  required></select>
                                            </div>
                        ...
                        <!-- end row -->
                                        ...
                                        <button type="submit" class="btn btn-danger">Order Submit</button>
              ...
              @section('scripts')
                 ...
                 function dynamic_field(number)
                 {
                  ...
                  html = '<tr>';
                        ...
                        html += '<td><input type="text" name="prefix[]" required class="form-control"/></td>';
                        html += '<td><input type="text" name="part_number[]" required class="form-control"/></td>';
                        html += '<td><input type="number" name="quantity[]" required class="form-control qty" /><input type="hidden" name="total_quantity" class="form-control tqty"  /></td>';
                        html += '<td><input type="text" name="priority[]" class="form-control"/></td>';
...
<script type="text/javascript">
    $('.livesearch4').select2({
        ...
        ajax: {
            url: '/ajax-autocomplete-requester',
            dataType: 'json',
            delay: 250,
            processResults: function(data) {
                return {
