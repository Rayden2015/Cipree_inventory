    ...
    <body>
        ...
        @endif
            <div class="card-header">
                ...
                @elseif(Auth::user()->hasRole('authhoriser'))
                    <a href="{{ route('authorise.all_requests') }}" class="btn btn-primary float-right">Back</a>
                @endif
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('orders.update', $purchase->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary">
                        ...
                        {{-- @if (Auth::user()->role->name == 'admin' || Auth::user()->role->name == 'store_officer' || Auth::user()->role->name == 'store_assistant') --}}
                        @if($purchase->status == 'Supplied')
                      
                        <div class="card-footer">
                            <label for="">Items Already Supplied</label>
                        </div>
                        @else
                        <div class="card-footer">
