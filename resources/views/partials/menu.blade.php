            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                @can('inventory-management-module')
                    <li
                        class="nav-item {{ request()->is('items*','product_history','product_history_show*', 'locations*', 'stores*', 'inventories*', 'categories*', 'spr_lists*', 'auth_spr_lists*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->is('items*','product_history','product_history_show*', 'locations*', 'stores*', 'inventories*', 'categories*', 'spr_lists*', 'auth_spr_lists*') ? 'active' : '' }}">
                            <i>
