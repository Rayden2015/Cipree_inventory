                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    @forelse ($unstocked as $in)
                        <tbody>
                            <tr>
                                <td>{{ $in->id }}</td>
                                <td>{{ $in->item->item_description ?? 'Not found in items table, modify inventory records' }}</td>
                                <td>{{ $in->item->item_part_number ?? 'Not found in items table, modify inventory records' }}</td>
                                <td>{{ $in->item->item_stock_code ?? 'Not found in items table, modify inventory records' }}</td>
                                <td>{{ $in->quantity ?? '' }}</td>
