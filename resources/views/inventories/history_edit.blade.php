    ...
    <body>
        ...
        @endif
            ...
            <div class="card-body">
                ...
                <form action="{{ route('inventories.inventory_history_update', $inventory->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="edl">
                                    <div class="form-group">
                                        ...
                                        <select class="select form-control" id="billing_currency" name="billing_currency"
                        ...
                        <tbody>
                            @if (isset($inventory_items))
                                @foreach ($inventory_items as $ph)
                                    <tr>
                                        <td>{{ $ph->id ?? '' }}</td>
                                        <form action="{{ route('inventories.update_inventory_history', $ph->id) }}"
                                            ...
                                            <td>
                                                ...
                                                <select data-placeholder="Choose..." name="item_id" id="item_id"
                                                    readonly class="select-search form-control">
                                                    <option value=""></option>
                                                    @foreach ($items as $itm)
                                                        <option {{ $ph->item_id == $itm->id ? 'selected' : '' }}
                                                            value="{{ $itm->id }}">
                                                            {{ $itm->item_description . ' ' . $itm->item_stock_code }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <td>
                                                @if (Auth::user()->hasRole('store_officer'))
                                                    ...
                                                    <input value="{{ $ph->quantity ?? '' }}" type="number"
                                                        name="quantity" class="form-control">
                                                @elseif(Auth::user()->hasRole('store_assistant'))
                                                    <input value="{{ $ph->quantity ?? '' }}" type="number" readonly
                                                        name="quantity" class="form-control">
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                @if($inventory->billing_currency == 'Dollar')
                                                    <input value="{{  $ph->unit_cost_exc_vat_gh ?? '' }}"
                                                        type="text" name="unit_cost_exc_vat_gh" class="form-control">
                                                @else
                                                    <input value="{{ $ph->unit_cost_exc_vat_gh ?? '' }}" type="text"
                                                        name="unit_cost_exc_vat_gh" class="form-control">
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <input value="{{ $ph->amount ?? '' }}" type="text" name="amount"
                                                        readonly class="form-control">
                                                @endif
                                            </td>
                                            <td><input value="{{ $ph->discount ?? '' }}" type="text" name="discount"
                                                    class="form-control"></td>

                                            <td>
                                                <select data-placeholder="Choose..." name="location_id" id="location_id"
                                                    class="select-search form-control">
                                                    <option value=""></option>
