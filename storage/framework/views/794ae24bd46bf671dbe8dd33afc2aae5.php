<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('store-officer-dashboard')): ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div style="background-color: #19AF9D;" class="small-box" id="rcorners1">
                ...
                <a href="<?php echo e(route('items_list_site')); ?>" class="small-box-footer">More info <i
        ...
        <div class="col-lg-3 col-6">
            ...
            <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                <div class="inner">
                    ...
                    <h4 style="color: white; font-family: 'Segoe UI Light';"><?php echo e($reorder_level); ?></h4>
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger" id="rcorners1">
                <div class="inner">
                    ...
                    <h4 style="color: white; font-family: 'Segoe UI Light';"><?php echo e($out_of_stock); ?></h4>
...
<?php endif; ?>
 ...
 <?php /**PATH C:\Users\Hackman_GH\Desktop\Projects\inventory-v2\resources\views/dashboard/store_officer.blade.php ENDPATH**/ ?>