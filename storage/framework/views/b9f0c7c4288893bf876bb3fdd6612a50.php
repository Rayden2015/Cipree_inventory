            ...
            <div class="col-lg-3 col-6">
                ...
                <div style="background-color: #0e6258;" class="small-box" id="rcorners1">
                    <div class="inner">
                        ...
                        <h4 style="color: white; font-family: 'Segoe UI Light';"><?php echo e('$ ' . $po_total_value_of_approved_pos_mtd); ?></h4>
                    ...
                    <a href="<?php echo e(route('dashboard.po_total_value_of_approved_pos_mtd')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div style="background-color: #19AF9D" class="small-box" id="rcorners1">
                    <div class="inner">
                        <h4 style="color: white; font-family: 'Segoe UI Light';"><?php echo e('$ ' . $po_total_value_of_supplied_pos_mtd); ?></h4>
             ...
             <div class="col-lg-3 col-6">
                ...
                <div style="background-color: #0e6258;" class="small-box " id="rcorners1">
                    <div class="inner">
                        ...
                        <h4 style="color: white; font-family: 'Segoe UI Light';"><?php echo e('$ ' . $po_total_value_of_pending_pos_mtd); ?></h4>
                    ...
                    <a href="<?php echo e(route('dashboard.po_total_value_of_pending_pos_mtd')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sappxaph/fastnet.sapphirehillsint.com/resources/views/dashboard/purchasing_officer.blade.php ENDPATH**/ ?>