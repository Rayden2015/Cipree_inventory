            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <li
                        class="nav-item <?php echo e(request()->routeIs('company.index', 'users.index', 'reviews.index', 'sites*', 'roles*', 'permissions*', 'uom*','send.bulk.email') ? 'menu-open' : ''); ?>">
                        <a href="#"
                            class="nav-link <?php echo e(request()->routeIs('company.index', 'users.index', 'reviews.index', 'sites*', 'roles*', 'permissions*', 'uom*','send.bulk.email') ? 'active' : ''); ?>">
                            <i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bulk-mails')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('send.bulk.email')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('send.bulk.email') ? 'active' : ''); ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Bulk Emails</p>
                                </a>
                            </li>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-uom')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('uom.index')); ?>"
                                        class="nav-link <?php echo e(request()->routeIs('uom.index') ? 'active' : ''); ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>UoM</p>
                                    </a>
                                </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('employee-management-module')): ?>
                    <li class="nav-item <?php echo e(request()->routeIs('employees*') ? 'menu-open' : ''); ?>">
                        <a href="#" class="nav-link <?php echo e(request()->routeIs('employees*') ? 'active' : ''); ?>">
                            <i>
                                <img src="<?php echo e(asset('assets/images/icons/emp.png')); ?>"width="26" height="26"
                                    alt="" />
                            </i>
                            <p>
                                Employee Management
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('employees.index')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('employees.index') ? 'active' : ''); ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Employees</p>
                                </a>
                            </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventory-management-module')): ?>
                    <li
                        class="nav-item <?php echo e(request()->is('items*', 'locations*', 'stores*', 'inventories*', 'categories*', 'spr_lists*', 'auth_spr_lists*','itemspersite','product_history','product_history_show*') ? 'menu-open' : ''); ?>">
                        <a href="#"
                            class="nav-link <?php echo e(request()->is('items*', 'locations*', 'stores*', 'inventories*', 'categories*', 'spr_lists*', 'auth_spr_lists*','itemspersite','product_history','product_history_show*') ? 'active' : ''); ?>">
                            <i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('item-history')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('product_history')); ?>"
                                    class="nav-link <?php echo e(request()->routeIs('product_history') ? 'active' : ''); ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Item History</p>
                                </a>
                            </li>
...
<?php /**PATH C:\Users\Hackman_GH\Desktop\Projects\inventory-v2\resources\views/partials/menu.blade.php ENDPATH**/ ?>