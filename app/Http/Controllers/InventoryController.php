...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        // Fix N+1 query by eager loading supplier, enduser, user, and delivery relationships
        $inventories = Inventory::with(['supplier', 'enduser', 'user', 'delivery'])
...
}public function update_inventory_item(Request $request, $id)
{
    try {
        ...
        return $this->handleError($e, 'update_inventory_item()');
    }
}
    ...
    public function bookUpdate(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'bookUpdate()');
}
    ...
    public function selectCategory(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'selectCategory()');
}
    ...
    public function selectLocation(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'selectLocation()');
}
    ...
    public function selectDeliveredBy(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'selectDeliveredBy()');
}
    ...
    public static function fetch_locations()
    {
        try {
            ...
            return $this->handleError($e, 'fetch_locations()');
}
    ...
    public static function getItem()
    {
        try {
            ...
            return $this->handleError($e, 'getItem()');
}
    ...
    public function inventory_action(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_action()');
}
    ...
    public function inventory_search(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_search()');
}
    ...
    public function inventory_home_search(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_home_search()');
}
    ...
    public function inventory_item_history()
    {
        try {
            ...
            return $this->handleError($e, 'inventory_item_history()');
}
    ...
    public function inventory_history_show(string $id)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_show()');
}
    ...
    public function inventory_history_edit(string $id)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_edit()');
}
    ...
    public function inventory_history_update(Request $request, string $id)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_update()');
}
    ...
    public function inventory_history_action(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_action()');
}
    ...
    public function update_inventory_history(Request $request, $id)
    {
        try {
            ...
            return $this->handleError($e, 'update_inventory_history()');
}
    ...
    public function inventory_history_search(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_search()');
}
    ...
    public function inventory_history_date_search(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_date_search()');
}
    ...
    public function inventory_history_destroy($id)
    {
        try {
            ...
            return $this->handleError($e, 'inventory_history_destroy()');
}
    ...
    public function generateinventoryPDF($id)
    {
        try {
            ...
            return $this->handleError($e, 'generateinventoryPDF()');
}
    ...
    public function out_of_stock_search(Request $request)
    {
        try {
            ...
            return $this->handleError($e, 'out_of_stock_search()');
}
