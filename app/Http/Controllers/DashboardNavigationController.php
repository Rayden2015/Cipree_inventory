      ...
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $pending_po_approvals = Porder::where('id', null)->paginate(15);
            } else {
   ...
   public function approved_request()
   {
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $approved_request = Order::where('id', null)->paginate(15);
            } else {
   ...
   public function approved_pos()
   {
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $approved_pos = Porder::where('id', null)->paginate(15);
            } else {
   ...
   public function processed_request()
   {
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $processed_request = Sorder::where('id', null)->paginate(15);
            } else {
   ...
   public function pending_request_approvals()
   {
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $pending_request_approvals = Order::where('id', null)->paginate(15);
            } else {
   ...
   public function processed_pos()
   {
      try {
         ...
         if (Auth::user()->hasRole('Department Authoriser')) {
            ...
            if ($department_id === null) {
               $processed_pos = Porder::where('id', null)->paginate(15);
            } else {
