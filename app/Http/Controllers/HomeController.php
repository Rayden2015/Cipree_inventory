...
if ($department_id === null) {
    ...
    // Pass all dashboard variables with safe defaults so included partials (e.g. store_officer) never see undefined vars.
    return view('home', [
        ...
        'total_no_of_parts' => 0,
        'total_cost_of_partss' => 0,
        'total_cost_of_parts_issued' => 0,
        'sub_total_cost_of_parts' => 0,
        'total_cost_of_parts' => '0.00',
        'stockValueByType' => collect(),
        'total_cost_of_parts_within_the_month' => '0.00',
        'stockDistribution' => collect(),
        'total_value_items_received_mtd' => '0.00',
        'active_user_accounts' => 0,
        'disabled_user_accounts' => 0,
        'active_endusers' => 0,
        'disabled_endusers' => 0,
        'departments' => 0,
        'sections' => 0,
        ...
        'ordered' => 0,
        'delivered' => 0,
        'rfi_pending_approval' => 0,
        'rfi_approved_requests' => 0,
        'rfi_processed_requests' => 0,
        'rfi_denied' => 0,
        'dpr_pending_approval' => 0,
        'dpr_approved' => 0,
        'dpr_processed' => 0,
        'dpr_denied' => 0,
        'new_approvals' => 0,
        ...
        'pending_request_approvals' => 0,
        'pending_stock_approvals' => 0,
        'approved_pos' => 0,
        'approved_request' => 0,
        'processed_pos' => 0,
        'processed_request' => 0,
        'po_total_number_of_requests_mtd' => 0,
        'po_total_value_of_approved_pos_mtd' => 0,
        'po_total_value_of_supplied_pos_mtd' => 0,
        'po_total_value_of_pending_pos_mtd' => 0,
        'po_approved_stock_requests' => 0,
        'po_approved_direct_requests' => 0,
        'po_approved_pos' => 0,
        'po_denied_requests' => 0,
        'user_complaints_open' => 0,
        'stock_request_pending' => 0,
        'sofficer_stock_request_pending' => 0,
        'out_of_stock' => 0,
        'reorder_level' => 0,
        'depart_auth_new_approvals' => null,
        'depart_auth_pending_request_approvals' => null,
