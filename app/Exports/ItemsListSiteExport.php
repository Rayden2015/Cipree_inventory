    ...
    */
    public function collection()
    {
        ...
        return $inventoryItems->map(function($item) {
            ...
            // Calculate amount as unit cost multiplied by quantity
            $amount = $item->unit_cost_exc_vat_gh * $item->quantity;
    
            // Check if supplier_name is null, provide a default value if necessary
            $supplierName = $item->supplier_name ?? '';
    
            // Return a new array with the calculated 'age', 'amount', and original fields
            return [
