...
class CreateTestAuthorisers extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test:create-authorisers';
     ...
     * @var string
     */
    protected $description = 'Create test users for Super Authoriser and Department Authoriser';
    ...
    public function handle()
    {
        ...
        $this->info('');
        $this->info('Super Authoriser: super.authoriser@test.com / password');
        $this->info('Department Authoriser: dept.authoriser@test.com / password');
        $this->info('Requester (Engineering): requester@test.com / password');
        $this->info('Requester (Finance): requester2@test.com / password');
